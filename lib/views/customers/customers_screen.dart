                ...
                builder: (controller) {
                  return myLocation.when(data: (data) {
                    ...
                    if(userFiltered== true){
                      ...
                      myCustomers.addAll(controller.lstcustomers.where((element) => element.createdBy == userCode).toList());
                    }else{
                      myCustomers = controller.lstcustomers;
                    }
                    if(customerStatusView == "Approved"){
                      myCustomers = myCustomers.where((element) => element.approval!.toLowerCase() == "approved").toList();
                    }else{
                      myCustomers = myCustomers.where((element) => element.approval!.toLowerCase() == "waiting_approval").toList();
                    }
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        CustomButton(
                                          ...
                                          text: 'Approved',
                                          isSelected: customerStatusView == "Approved",
                                        ),
                                        CustomButton(
                                          action: () {
                                            setState(() {
                                              customerStatusView = "Not_Approved";
                                            });
                                            setState(() {
                                          ...
                                          text: 'Not Approved',
                                          isSelected: customerStatusView == "Not_Approved",
                                        ),
                                      ],
                                    ),
                                  ),
