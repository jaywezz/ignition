...
class _OrdersScreenState extends State<OrdersScreen> {
  ...
  void initState() {
    ...
    Get.find<OrdersController>().getSalesOrders(customer_id.toString());
    super.initState();
  }
      ...
      body: SafeArea(
        child: GetBuilder<OrdersController>(builder: (orderController) {
          ...
          if (dateRange.isNotEmpty) {
            orders = orderController.lstorders
                .where((item) =>
                      ...
                      child: orderController.isLoading
                          ...
                          : orders.isEmpty
                              ...
                              : RefreshIndicator(
                                  onRefresh: () async {
                                    return await orderController
                                        .getSalesOrders(customer_id.toString());
                                  },
