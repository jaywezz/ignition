...
class PrescenceSection extends ConsumerStatefulWidget {
  const PrescenceSection({Key? key}) : super(key: key);

  @override
  ConsumerState<PrescenceSection> createState() => _PrescenceSectionState();
}

class _PrescenceSectionState extends ConsumerState<PrescenceSection> {
  @override
                              ...
                              child: TextFormField(
                                ...
                                onChanged: (String value) {
                                  ...
                                  if (int.parse(value) > 0) {
                                    ...
                                    //     .addAvailableProductsCart(cartData);
                                  }
                                },
