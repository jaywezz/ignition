...
class SalesCheckoutForm extends ConsumerStatefulWidget {
  const SalesCheckoutForm({Key? key}) : super(key: key);

  @override
  ConsumerState<SalesCheckoutForm> createState() => _SalesCheckoutFormState();
}

class _SalesCheckoutFormState extends ConsumerState<SalesCheckoutForm>
          ...
          action: () async {
            if(currentIndex ==1){
              if(form3.currentState!.validate()){
                Get.dialog(CheckoutDialogWidget(
