...
class ReceiveDeliveryItemsWidget extends StatefulWidget {
  final List<DeliveryItemModel> orderItems;
  ReceiveDeliveryItemsWidget({Key? key, required this.orderItems}) : super(key: key);

  @override
  State<ReceiveDeliveryItemsWidget> createState() => _ReceiveDeliveryItemsWidgetState();
}

class _ReceiveDeliveryItemsWidgetState extends State<ReceiveDeliveryItemsWidget> {
